...
# Clé API et URL de base pour Pl@ntNet
...
def resize_image(image_path, max_size=(800, 800), quality=70):
    """Redimensionner et compresser une image avant envoi."""
    try:
...
def identify_plant(image_path, organ):
    """Envoyer une image à l'API Pl@ntNet pour identification."""
...
def copy_and_rename_file(file_path, dest_folder, new_name, count):
    """Copier et renommer un fichier selon l'identification."""
