...
# -*- coding: utf-8 -*-
"""Worker léger pour l'export QGIS.
Ce module est isolé de toute dépendance UI pour être utilisé dans des
sous-processus multiprocesse."""
...
def test_qgis_import(cfg: Dict) -> Tuple[str, str]:
    qt_base = _prepare_qgis_env(cfg)
    from qgis.core import QgsApplication  # noqa: F401
    qpa = os.environ.get("QT_QPA_PLATFORM", "")
    return qpa, os.path.basename(qt_base) if qt_base else ""
