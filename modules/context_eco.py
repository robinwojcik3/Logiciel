...
from .utils import normalize_name, to_long_unc

# Constantes utilisées par le module Contexte éco
...
def worker_run(args: Tuple[List[str], dict]) -> Tuple[int, int]:
    """Traitement lourd d'export des cartes sous QGIS."""
    projects, cfg = args
...
def discover_projects() -> List[str]:
    """Découvrir automatiquement les projets QGIS sur le partage réseau."""
