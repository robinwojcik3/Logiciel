...
# -*- coding: utf-8 -*-
r"""
Ce script nécessite l'interpréteur Python de l'environnement virtuel geopandas
Interpréteur: C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Configuration Python\venv_geopandas\Scripts\python.exe
"""
...
parser.add_argument("--aire", required=True, help="Shapefile de l'aire d'étude élargie")
parser.add_argument("--zone", required=True, help="Shapefile de la zone d'étude")
args = parser.parse_args()

# Affectation des chemins d'accès aux variables
couche_reference1 = args.aire
couche_reference2 = args.zone
