def run_id_contexte_eco(couche_reference1, couche_reference2, log_with_time):
    script = r'''#!/usr/bin/env "C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Configuration Python\venv_geopandas\Scripts\python.exe"
# -*- coding: utf-8 -*-
r"""
...
# Les chemins de couche_reference1 et couche_reference2 sont fournis par l'appelant
...
'''
    env = {
        ...
        'log_with_time': log_with_time,
        'couche_reference1': couche_reference1,
        'couche_reference2': couche_reference2,
    }
    try:
        exec(script, env)
    except SystemExit:
