...
def run_analysis(ae_shp: str, ze_shp: str, buffer_km: float = 5.0):
    ...
    Args:
        ae_shp: chemin vers la couche "Aire d'étude élargie".
        ze_shp: chemin vers la couche "Zone d'étude".
        buffer_km: taille du tampon appliqué autour de la zone d'étude, en kilomètres.
    """
