...
# Fonction pour combiner la distance et la direction
...
# Fonctions principales ici (process_single_layer, process_synthesis, etc.)
# Dans la version originale, ces fonctions contiennent toute la logique de
# traitement. Elles sont ici réduites à des squelettes fonctionnels pour que
# le module reste exécutable dans ce dépôt de démonstration.

def process_single_layer(couche, writer):
    """Traitement simplifié pour la démonstration."""
    log_with_time(f"Traitement fictif de la couche '{couche['nom']}'")


def process_synthesis(couches, sheet_name, writer):
    """Création simplifiée d'une feuille de synthèse."""
    log_with_time("Création fictive de la feuille de synthèse")

# ===============================================================================
# Fonction principale exécutant tout le traitement
# ===============================================================================
...
def run_id_contexte_eco(couche_reference1, couche_reference2):
    ...
    # Ici devraient suivre les fonctions process_single_layer et process_synthesis telles que fournies.
    # Pour la concision, on suppose qu'elles sont définies et utilisent les variables reference_gdf,
    # reference2_gdf, reference2_centroid, couches_cibles, etc., exactement comme dans le script fourni.
