...
# Affectation des chemins d'accès aux variables via les arguments de ligne de commande
if len(sys.argv) != 3:
    log_with_time("Usage: id_contexte_eco.py <aire_etude_elargie.shp> <zone_etude.shp>")
    sys.exit(1)

couche_reference1 = sys.argv[1]
couche_reference2 = sys.argv[2]
