...
def run_id_contexte_eco(couche_reference1, couche_reference2):
    """Exécute l'identification des zonages à partir des deux shapefiles fournis."""
    # Imports lourds effectués ici pour éviter les erreurs si les dépendances ne sont pas installées
