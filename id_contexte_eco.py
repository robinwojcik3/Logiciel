...
IDCE_OUTPUT_DIR = r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\OUTPUT"


def run_id_contexte_eco(couche_reference1: str, couche_reference2: str, log_fn=print):
    """Exécute le script d'identification des zonages."""
    def log_with_time(message):
        now = datetime.datetime.now().strftime("%H:%M:%S")
        log_fn(f"[{now}] {message}")
    ...
    log_with_time(f"PROJ_LIB défini à: {os.environ['PROJ_LIB']}")
    log_with_time(f"GDAL_DATA défini à: {os.environ['GDAL_DATA']}")
    ...
    couches_cibles = [
        {'nom': 'N2000 ZPS', 'chemin': r"C:\Users\utilisateur\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\N2000 ZPS.shp", 'attributs': ['SITENAME', 'SITECODE']},
        {'nom': 'N2000 ZSC', 'chemin': r"C:\Users\utilisateur\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\N2000 ZSC.shp", 'attributs': ['SITENAME', 'SITECODE']},
        {'nom': 'ZNIEFF de Type I', 'chemin': r"C:\Users\utilisateur\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZNIEFF de type I.shp", 'attributs': ['NOM','ID_MNHN','ID_ORG']},
        {'nom': 'ZNIEFF de Type II', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZNIEFF de type II.shp", 'attributs': ['NOM','ID_MNHN','ID_ORG']},
        {'nom': 'APPB', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\APPB.shp", 'attributs': ['NOM_SITE','ID_MNHN','URL_FICHE','OPERATEUR']},
        {'nom': 'APPHN', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\APPHN.shp", 'attributs': ['NOM_SITE','ID_MNHN','URL_FICHE','OPERATEUR']},
        {'nom': 'Terrain CEN - Terrain gere', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Terrain CEN - Terrain gere.shp", 'attributs': ['ID_MNHN','NOM_SITE']},
        {'nom': 'Terrain CEN - Terrain acquis', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Terrain CEN - Terrain acquis.shp", 'attributs': ['ID_MNHN','NOM_SITE']},
        {'nom': 'ENS', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ENS.shp", 'attributs': ['NOM_SITE','ID_MNHN','URL_FICHE','GEST_SITE','OPERATEUR','STAT_FON']},
        {'nom': 'Parc Nationaux', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Parc Nationaux.shp", 'attributs': ['NOM_SITE','ID_MNHN','ID_LOCAL','PPN_ASSO','URL_FICHE','GEST_SITE','OPERATEUR']},
        {'nom': 'Parc Naturels Régionaux', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Parc Naturels Regionaux.shp", 'attributs': ['NOM_SITE','ID_MNHN','GEST_SITE','URL_FICHE']},
        {'nom': 'Réserve biologique', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Réserve biologique.shp", 'attributs': ['NOM_SITE','ID_MNHN','GEST_SITE','URL_FICHE']},
        {'nom': 'Réserve de biosphère', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Réserve de biosphère.shp", 'attributs': ['NOM_SITE','ID_MNHN','GEST_SITE','URL_FICHE','OPERATEUR']},
        {'nom': 'Réserve intégrale de PN', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Réserve intégrale de PN.shp", 'attributs': ['NOM_SITE','ID_MNHN','GEST_SITE','URL_FICHE','OPERATEUR','ID_PN']},
        {'nom': 'Réserve nationale', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Réserve nationale.shp", 'attributs': ['NOM_SITE','ID_MNHN','ID_LOCAL','URL_FICHE','ACTE_DEB','GEST_SITE','OPERATEUR']},
        {'nom': 'Réserve régionale', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Réserve régionale.shp", 'attributs': ['NOM_SITE','ID_MNHN','ID_LOCAL','URL_FICHE','ACTE_DEB','GEST_SITE','OPERATEUR']},
        {'nom': 'ZH 01', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 01.shp", 'attributs': ['nom','id_map','id_local','url']},
        {'nom': 'ZH 26', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 26.shp", 'attributs': ['site_name','nom_bv','site_cod','sdage']},
        {'nom': 'ZH 38', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 38.shp", 'attributs': ['nom','id_map','id_local','url']},
        {'nom': 'ZH 69', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 69.shp", 'attributs': ['nom','id_map','id_local','url']},
        {'nom': 'ZH 73', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 73.shp", 'attributs': ['site_name','id_bdd']},
        {'nom': 'ZH 74', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH 74.shp", 'attributs': ['NOM']},
        {'nom': 'ZH Bourgogne', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH Bourgogne.shp", 'attributs': ['nom','id_map','id_local','url']},
        {'nom': 'ZH PACA', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\ZH PACA.shp", 'attributs': ['site','code','lib_ssbv','type_sdage']},
        {'nom': 'Pelouses sèches 38', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Pelouses sèches 38.dbf", 'attributs': ['LEGENDE','ID']},
        {'nom': 'Pelouses sèches 73', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Pelouses sèches 73.dbf", 'attributs': ['site_name','id_bdd']},
        {'nom': 'Pelouses sèches 74', 'chemin': r"C:\USERS\UTILISATEUR\Mon Drive\1 - Bota & Travail\+++++++++  BOTA  +++++++++\---------------------- 3) BDD\PYTHON\2) Contexte éco\INPUT\Tables pour ID zonages\Pelouses sèches 74.dbf", 'attributs': ['Site','ID']}
    ]

    nom_fichier_sortie = 'ID zonages.xlsx'
    chemin_sortie = os.path.join(IDCE_OUTPUT_DIR, nom_fichier_sortie)
    ...
    def process_single_layer(couche, writer):
        ...
        try:
            overlapping_gdf['Distance et Direction'] = overlapping_gdf.apply(
                lambda row: combine_distance_and_direction(row['Distance (km)'], row['Azimuth']), axis=1)
        ...
        for row_idx in range(data_start_row + 1, data_end_row + 2):
            for col_idx in range(start_col, end_col + 1):
                ...
                cell.border = border
                cell.alignment = alignment
                cell.fill = data_fill_even if (row_idx - data_start_row) % 2 == 0 else data_fill_odd
        for col_idx in range(start_col, end_col + 1):
    ...
    def process_synthesis(couches, sheet_name, writer):
        log_with_time("Création de la feuille de synthèse...")
        all_results = []
        code_field_mapping = {'N2000 ZPS': 'SITECODE', 'N2000 ZSC': 'SITECODE', 'ZNIEFF de Type I': 'ID_MNHN', 'ZNIEFF de Type II': 'ID_MNHN'}
        for couche in couches:
            ...
            if nom_couche in ['ZH 38', 'Pelouses sèches']:
                ...
                temp_df = pd.DataFrame({'Type de zonage': [type_zonage], 'Distance à la zone d\'étude': ['/'], 'Nom du site': [nom_du_site], '': [''], 'CODES': ['']})
            ...
            try:
                ...
                log_with_time(f"Erreur lors de l'extraction des attributs dans '{nom_couche}': {e}")
                continue
            temp_df.rename(columns={'Distance et Direction': 'Distance à la zone d\'étude', name_attr: 'Nom du site'}, inplace=True)
        ...
        if all_results:
            ...
            results_df['Distance numérique'] = results_df["Distance à la zone d'étude"].apply(lambda x: float(x.split(' ')[0]) if x != '/' and not x.startswith("Se") else float('inf'))
